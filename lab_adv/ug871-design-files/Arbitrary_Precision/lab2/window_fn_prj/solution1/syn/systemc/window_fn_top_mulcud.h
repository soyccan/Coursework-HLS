...
// ==============================================================
#ifndef __window_fn_top_mulcud__HH__
#define __window_fn_top_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(window_fn_top_mulcud) {
    ...
    SC_CTOR(window_fn_top_mulcud):  ACMP_smul_us_U ("ACMP_smul_us_U") {
