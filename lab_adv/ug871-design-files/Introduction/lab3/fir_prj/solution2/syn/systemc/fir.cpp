...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_icmp_ln67_fu_156_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_fu_148_p3 );
    sensitive << ( i_0_reg_116 );

    SC_METHOD(thread_mul_ln74_fu_175_p0);
    sensitive << ( c_q0 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_mul_ln74_fu_175_p2);
    sensitive << ( data_0_reg_128 );
    sensitive << ( mul_ln74_fu_175_p0 );

    SC_METHOD(thread_sext_ln66_fu_144_p1);
    sensitive << ( i_0_reg_116 );

    SC_METHOD(thread_shift_reg_address0);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( icmp_ln67_fu_156_p2 );
    sensitive << ( tmp_fu_148_p3 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( zext_ln71_fu_162_p1 );
    sensitive << ( zext_ln71_1_fu_167_p1 );
    ...
    SC_METHOD(thread_zext_ln71_1_fu_167_p1);
    sensitive << ( sext_ln66_reg_193 );

    SC_METHOD(thread_zext_ln71_fu_162_p1);
    sensitive << ( grp_fu_137_p2 );

    SC_METHOD(thread_zext_ln74_fu_171_p1);
    sensitive << ( sext_ln66_reg_193 );
    ...
    sc_trace(mVcdFile, sext_ln66_fu_144_p1, "sext_ln66_fu_144_p1");
    sc_trace(mVcdFile, sext_ln66_reg_193, "sext_ln66_reg_193");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, icmp_ln67_fu_156_p2, "icmp_ln67_fu_156_p2");
    sc_trace(mVcdFile, icmp_ln67_reg_202, "icmp_ln67_reg_202");
    ...
    sc_trace(mVcdFile, data_0_reg_128, "data_0_reg_128");
    sc_trace(mVcdFile, zext_ln71_fu_162_p1, "zext_ln71_fu_162_p1");
    sc_trace(mVcdFile, zext_ln71_1_fu_167_p1, "zext_ln71_1_fu_167_p1");
    sc_trace(mVcdFile, zext_ln74_fu_171_p1, "zext_ln74_fu_171_p1");
    sc_trace(mVcdFile, grp_fu_137_p0, "grp_fu_137_p0");
    sc_trace(mVcdFile, mul_ln74_fu_175_p0, "mul_ln74_fu_175_p0");
    sc_trace(mVcdFile, mul_ln74_fu_175_p2, "mul_ln74_fu_175_p2");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        acc_0_reg_103 = acc_fu_181_p2.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(icmp_ln67_reg_202.read(), ap_const_lv1_0))) {
        data_0_reg_128 = shift_reg_q0.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_148_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln67_fu_156_p2.read(), ap_const_lv1_1))) {
        data_0_reg_128 = x_in_sig.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        i_0_reg_116 = i_reg_221.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, x_ap_vld_in_sig.read())))) {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
             esl_seteq<1,1,1>(tmp_fu_148_p3.read(), ap_const_lv1_1))) {
            x_ap_vld_preg = ap_const_logic_0;
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_reg_221 = grp_fu_137_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_148_p3.read(), ap_const_lv1_0))) {
        icmp_ln67_reg_202 = icmp_ln67_fu_156_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        sext_ln66_reg_193 = sext_ln66_fu_144_p1.read();
    }
}

void fir::thread_acc_fu_181_p2() {
    acc_fu_181_p2 = (!mul_ln74_fu_175_p2.read().is_01() || !acc_0_reg_103.read().is_01())? sc_lv<32>(): (sc_biguint<32>(mul_ln74_fu_175_p2.read()) + sc_biguint<32>(acc_0_reg_103.read()));
}
...
void fir::thread_c_address0() {
    c_address0 =  (sc_lv<4>) (zext_ln74_fu_171_p1.read());
}
...
void fir::thread_grp_fu_137_p2() {
    grp_fu_137_p2 = (!grp_fu_137_p0.read().is_01() || !ap_const_lv5_1F.is_01())? sc_lv<5>(): (sc_bigint<5>(grp_fu_137_p0.read()) + sc_bigint<5>(ap_const_lv5_1F));
}

void fir::thread_icmp_ln67_fu_156_p2() {
    icmp_ln67_fu_156_p2 = (!i_0_reg_116.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_116.read() == ap_const_lv5_0);
}

void fir::thread_mul_ln74_fu_175_p0() {
    mul_ln74_fu_175_p0 = c_q0.read();
}

void fir::thread_mul_ln74_fu_175_p2() {
    mul_ln74_fu_175_p2 = (!mul_ln74_fu_175_p0.read().is_01() || !data_0_reg_128.read().is_01())? sc_lv<32>(): sc_bigint<32>(mul_ln74_fu_175_p0.read()) * sc_bigint<32>(data_0_reg_128.read());
}

void fir::thread_sext_ln66_fu_144_p1() {
    sext_ln66_fu_144_p1 = esl_sext<32,5>(i_0_reg_116.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln71_1_fu_167_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_148_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln67_fu_156_p2.read(), ap_const_lv1_1))) {
        shift_reg_address0 = ap_const_lv4_0;
                ...
                esl_seteq<1,1,1>(tmp_fu_148_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln67_fu_156_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln71_fu_162_p1.read());
    } else {
...
void fir::thread_tmp_fu_148_p3() {
    tmp_fu_148_p3 = i_0_reg_116.read().range(4, 4);
}
...
void fir::thread_zext_ln71_1_fu_167_p1() {
    zext_ln71_1_fu_167_p1 = esl_zext<64,32>(sext_ln66_reg_193.read());
}

void fir::thread_zext_ln71_fu_162_p1() {
    zext_ln71_fu_162_p1 = esl_zext<64,5>(grp_fu_137_p2.read());
}

void fir::thread_zext_ln74_fu_171_p1() {
    zext_ln74_fu_171_p1 = esl_zext<64,32>(sext_ln66_reg_193.read());
}
...
void fir::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_148_p3.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
