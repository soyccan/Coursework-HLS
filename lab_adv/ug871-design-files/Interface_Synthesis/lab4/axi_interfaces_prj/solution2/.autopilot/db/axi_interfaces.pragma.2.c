...
# 57 "axi_interfaces.c"
void axi_interfaces (dout_t d_o[8 * 4], din_t d_i[8 * 4]) {_ssdm_SpecArrayDimSize(d_o, 32);_ssdm_SpecArrayDimSize(d_i, 32);
...
_ssdm_op_SpecInterface(d_i, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 57 "axi_interfaces.c"

_ssdm_op_SpecInterface(d_o, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 57 "axi_interfaces.c"
