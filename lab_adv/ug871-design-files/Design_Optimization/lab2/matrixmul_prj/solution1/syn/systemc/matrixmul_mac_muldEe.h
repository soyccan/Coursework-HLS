...
// ==============================================================
#ifndef __matrixmul_mac_muldEe__HH__
#define __matrixmul_mac_muldEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrixmul_mac_muldEe) {
    ...
    SC_CTOR(matrixmul_mac_muldEe):  simcore_mac_1_U ("simcore_mac_1_U") {
