...
// ==============================================================
#ifndef __duc_mul_mul_18s_1bkb__HH__
#define __duc_mul_mul_18s_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(duc_mul_mul_18s_1bkb) {
    ...
    SC_CTOR(duc_mul_mul_18s_1bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
