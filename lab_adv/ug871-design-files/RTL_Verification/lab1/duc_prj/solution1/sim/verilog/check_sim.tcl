...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.duc.autotvin_din_i.dat"
         "c.duc.autotvin_freq.dat"
         "c.duc.autotvout_dout_i.dat"
         "c.duc.autotvout_dout_q.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.duc.autotvout_dout_i.dat"
         "rtl.duc.autotvout_dout_q.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
