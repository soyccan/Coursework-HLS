# 1 "C:/wrk/ETH_ToE_Github/ug871-design-files/RTL_Verification/lab1/mixer.c"
# 1 "C:/wrk/ETH_ToE_Github/ug871-design-files/RTL_Verification/lab1/mixer.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/wrk/ETH_ToE_Github/ug871-design-files/RTL_Verification/lab1/mixer.c" 2
...
void mixer (
  ...
  if (ch && valid_in) {
    ...
    *Dout_I = (tmp + mix_SubDSP(Din_re, Din_im, sine))>>(16 -2);
    *Dout_Q = (tmp + mix_AddDSP(Din_re, Din_im, cosine))>>(16 -2);
