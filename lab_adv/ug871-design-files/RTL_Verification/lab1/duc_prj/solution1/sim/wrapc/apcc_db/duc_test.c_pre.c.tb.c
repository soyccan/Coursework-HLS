...
void AESL_WRAP_duc(signed int , signed short , signed int *, signed int *);
...
llvm_cbe_tmp__39:
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_duc(i18 signext 0, i16 zeroext 6628, i18* %%3, i18* %%4) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_43_count);
  AESL_WRAP_duc(((unsigned int )0), ((unsigned short )6628), (signed int *)llvm_cbe_tmp__3, (signed int *)llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__40:
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_duc(i18 signext 0, i16 zeroext 6628, i18* %%3, i18* %%4) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_45_count);
  AESL_WRAP_duc(((unsigned int )0), ((unsigned short )6628), (signed int *)llvm_cbe_tmp__3, (signed int *)llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned int )0));
printf("\nArgument  = 0x%X",((unsigned short )6628));
...
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_duc(i18 signext %%12, i16 zeroext 6628, i18* %%3, i18* %%4) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_124_count);
  AESL_WRAP_duc(llvm_cbe_tmp__6, ((unsigned short )6628), (signed int *)llvm_cbe_tmp__3, (signed int *)llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe__2e_thread:
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_duc(i18 signext %%storemerge2, i16 zeroext 6628, i18* %%3, i18* %%4) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_126_count);
  AESL_WRAP_duc(llvm_cbe_storemerge2, ((unsigned short )6628), (signed int *)llvm_cbe_tmp__3, (signed int *)llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__51:
if (AESL_DEBUG_TRACE)
printf("\n  %%57 = zext i1 %%56 to i32, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_208_count);
  llvm_cbe_tmp__37 = (unsigned int )((unsigned int )(bool )((llvm_cbe_tmp__36&4294967295U) != (0u&4294967295U))&1U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__37);
  if (AESL_DEBUG_TRACE)
      printf("\nEND @main}\n");
