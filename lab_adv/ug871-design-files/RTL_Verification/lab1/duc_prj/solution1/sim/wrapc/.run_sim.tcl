...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "duc.autotvin.dat"
	set constFileTvOut       "duc.autotvout.dat"
	set constFileHdlTvIn     "duc.autohdltvin.dat"
	set constFileHdlTvOut    "duc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
