...
// ==============================================================
# 1 "C:/wrk/ETH_ToE_Github/ug871-design-files/RTL_Verification/lab2/duc.c"
# 1 "C:/wrk/ETH_ToE_Github/ug871-design-files/RTL_Verification/lab2/duc.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/wrk/ETH_ToE_Github/ug871-design-files/RTL_Verification/lab2/duc.c" 2
...
void duc (
  ...
  imf2_data_t imf2_o;
  imf3_data_t imf3_o;
# 29 "C:/wrk/ETH_ToE_Github/ug871-design-files/RTL_Verification/lab2/duc.c"
  srrc(&srrc_o, din_i);
