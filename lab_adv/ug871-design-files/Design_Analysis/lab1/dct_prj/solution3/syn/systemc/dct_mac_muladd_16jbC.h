...
// ==============================================================
#ifndef __dct_mac_muladd_16jbC__HH__
#define __dct_mac_muladd_16jbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dct_mac_muladd_16jbC) {
    ...
    SC_CTOR(dct_mac_muladd_16jbC):  simcore_mac_0_U ("simcore_mac_0_U") {
