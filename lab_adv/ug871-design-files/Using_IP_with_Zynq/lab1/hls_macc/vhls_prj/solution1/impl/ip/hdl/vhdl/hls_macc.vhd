...
architecture behav of hls_macc is 
    ...
    "hls_macc,hls_ip_2019_1_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.115000,HLS_SYN_LAT=8,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=510,HLS_SYN_LUT=371,HLS_VERSION=2019_1_3}";
    ...
    signal mul_ln14_reg_100 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal add_ln14_fu_74_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln14_reg_105 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal select_ln12_fu_67_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                acc_reg <= add_ln14_fu_74_p2;
                add_ln14_reg_105 <= add_ln14_fu_74_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln14_fu_74_p2 <= std_logic_vector(unsigned(select_ln12_fu_67_p3) + unsigned(mul_ln14_reg_100));
