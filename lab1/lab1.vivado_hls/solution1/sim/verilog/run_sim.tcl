...
if {[file isfile multip_2num.autotvin.dat]} {
	file delete -force multip_2num.autotvin.dat
}

if {[file isfile multip_2num.autotvout.dat]} {
	file delete -force multip_2num.autotvout.dat
}
