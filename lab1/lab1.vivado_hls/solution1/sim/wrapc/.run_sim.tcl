...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "multip_2num.autotvin.dat"
	set constFileTvOut       "multip_2num.autotvout.dat"
	set constFileHdlTvIn     "multip_2num.autohdltvin.dat"
	set constFileHdlTvOut    "multip_2num.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
