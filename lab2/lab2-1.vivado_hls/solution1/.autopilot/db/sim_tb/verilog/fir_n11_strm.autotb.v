...
`define AESL_DEPTH_regXferLeng_V 1
`define AUTOTB_TVIN_pstrmInput_V_data_V  "./c.fir_n11_strm.autotvin_pstrmInput_V_data_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_keep_V  "./c.fir_n11_strm.autotvin_pstrmInput_V_keep_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_strb_V  "./c.fir_n11_strm.autotvin_pstrmInput_V_strb_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_user_V  "./c.fir_n11_strm.autotvin_pstrmInput_V_user_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_last_V  "./c.fir_n11_strm.autotvin_pstrmInput_V_last_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_id_V  "./c.fir_n11_strm.autotvin_pstrmInput_V_id_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_dest_V  "./c.fir_n11_strm.autotvin_pstrmInput_V_dest_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_data_V  "./c.fir_n11_strm.autotvin_pstrmOutput_V_data_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_keep_V  "./c.fir_n11_strm.autotvin_pstrmOutput_V_keep_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_strb_V  "./c.fir_n11_strm.autotvin_pstrmOutput_V_strb_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_user_V  "./c.fir_n11_strm.autotvin_pstrmOutput_V_user_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_last_V  "./c.fir_n11_strm.autotvin_pstrmOutput_V_last_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_id_V  "./c.fir_n11_strm.autotvin_pstrmOutput_V_id_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_dest_V  "./c.fir_n11_strm.autotvin_pstrmOutput_V_dest_V.dat"
`define AUTOTB_TVIN_an32Coef  "./c.fir_n11_strm.autotvin_an32Coef.dat"
`define AUTOTB_TVIN_regXferLeng_V  "./c.fir_n11_strm.autotvin_regXferLeng_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_data_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmInput_V_data_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_keep_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmInput_V_keep_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_strb_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmInput_V_strb_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_user_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmInput_V_user_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_last_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmInput_V_last_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_id_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmInput_V_id_V.dat"
`define AUTOTB_TVIN_pstrmInput_V_dest_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmInput_V_dest_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_data_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmOutput_V_data_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_keep_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmOutput_V_keep_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_strb_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmOutput_V_strb_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_user_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmOutput_V_user_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_last_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmOutput_V_last_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_id_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmOutput_V_id_V.dat"
`define AUTOTB_TVIN_pstrmOutput_V_dest_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_pstrmOutput_V_dest_V.dat"
`define AUTOTB_TVIN_an32Coef_out_wrapc  "./rtl.fir_n11_strm.autotvin_an32Coef.dat"
`define AUTOTB_TVIN_regXferLeng_V_out_wrapc  "./rtl.fir_n11_strm.autotvin_regXferLeng_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_data_V  "./c.fir_n11_strm.autotvout_pstrmOutput_V_data_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_keep_V  "./c.fir_n11_strm.autotvout_pstrmOutput_V_keep_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_strb_V  "./c.fir_n11_strm.autotvout_pstrmOutput_V_strb_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_user_V  "./c.fir_n11_strm.autotvout_pstrmOutput_V_user_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_last_V  "./c.fir_n11_strm.autotvout_pstrmOutput_V_last_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_id_V  "./c.fir_n11_strm.autotvout_pstrmOutput_V_id_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_dest_V  "./c.fir_n11_strm.autotvout_pstrmOutput_V_dest_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_data_V_out_wrapc  "./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_data_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_keep_V_out_wrapc  "./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_keep_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_strb_V_out_wrapc  "./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_strb_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_user_V_out_wrapc  "./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_user_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_last_V_out_wrapc  "./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_last_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_id_V_out_wrapc  "./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_id_V.dat"
`define AUTOTB_TVOUT_pstrmOutput_V_dest_V_out_wrapc  "./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_dest_V.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_regXferLeng_V = 1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.fir_n11_strm.autotvout_pstrmOutput_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fir_n11_strm.autotvout_pstrmOutput_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.fir_n11_strm.autotvout_pstrmOutput_V_data_V.dat with impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.fir_n11_strm.autotvout_pstrmOutput_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fir_n11_strm.autotvout_pstrmOutput_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.fir_n11_strm.autotvout_pstrmOutput_V_keep_V.dat with impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.fir_n11_strm.autotvout_pstrmOutput_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fir_n11_strm.autotvout_pstrmOutput_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.fir_n11_strm.autotvout_pstrmOutput_V_strb_V.dat with impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.fir_n11_strm.autotvout_pstrmOutput_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fir_n11_strm.autotvout_pstrmOutput_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.fir_n11_strm.autotvout_pstrmOutput_V_user_V.dat with impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.fir_n11_strm.autotvout_pstrmOutput_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fir_n11_strm.autotvout_pstrmOutput_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.fir_n11_strm.autotvout_pstrmOutput_V_last_V.dat with impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.fir_n11_strm.autotvout_pstrmOutput_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fir_n11_strm.autotvout_pstrmOutput_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.fir_n11_strm.autotvout_pstrmOutput_V_id_V.dat with impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.fir_n11_strm.autotvout_pstrmOutput_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fir_n11_strm.autotvout_pstrmOutput_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.fir_n11_strm.autotvout_pstrmOutput_V_dest_V.dat with impl_rtl.fir_n11_strm.autotvout_pstrmOutput_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_regXferLeng_V;
reg [31:0] size_regXferLeng_V;
reg [31:0] size_regXferLeng_V_backup;
...
begin
    ...
    `define STREAM_SIZE_IN_pstrmInput_V_data_V "./stream_size_in_pstrmInput_V_data_V.dat"
