...
if {[file isfile fir_n11_strm.autotvin.dat]} {
	file delete -force fir_n11_strm.autotvin.dat
}

if {[file isfile fir_n11_strm.autotvout.dat]} {
	file delete -force fir_n11_strm.autotvout.dat
}
