...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fir_n11_strm.autotvin.dat"
	set constFileTvOut       "fir_n11_strm.autotvout.dat"
	set constFileHdlTvIn     "fir_n11_strm.autohdltvin.dat"
	set constFileHdlTvOut    "fir_n11_strm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
