...
// ==============================================================
#ifndef __fir_n11_maxi_mul_bkb__HH__
#define __fir_n11_maxi_mul_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_n11_maxi_mul_bkb) {
    ...
    SC_CTOR(fir_n11_maxi_mul_bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
