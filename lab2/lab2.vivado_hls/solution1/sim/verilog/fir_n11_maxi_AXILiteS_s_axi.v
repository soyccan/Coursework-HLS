...
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    output wire [31:0]                   pn32HPInput,
    output wire [31:0]                   pn32HPOutput,
    input  wire [3:0]                    an32Coef_address0,
    input  wire                          an32Coef_ce0,
    output wire [31:0]                   an32Coef_q0,
    output wire [31:0]                   regXferLeng_V
);
//------------------------Address Info-------------------
...
localparam
    ...
    ADDR_IER                  = 8'h08,
    ADDR_ISR                  = 8'h0c,
    ADDR_PN32HPINPUT_DATA_0   = 8'h10,
    ADDR_PN32HPINPUT_CTRL     = 8'h14,
    ADDR_PN32HPOUTPUT_DATA_0  = 8'h18,
    ADDR_PN32HPOUTPUT_CTRL    = 8'h1c,
    ADDR_REGXFERLENG_V_DATA_0 = 8'h80,
    ADDR_REGXFERLENG_V_CTRL   = 8'h84,
    ADDR_AN32COEF_BASE        = 8'h40,
    ADDR_AN32COEF_HIGH        = 8'h7f,
    WRIDLE                    = 2'd0,
    WRDATA                    = 2'd1,
    WRRESP                    = 2'd2,
    WRRESET                   = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_pn32HPInput = 'b0;
    reg  [31:0]                   int_pn32HPOutput = 'b0;
    reg  [31:0]                   int_regXferLeng_V = 'b0;
    // memory signals
    wire [3:0]                    int_an32Coef_address0;
    wire                          int_an32Coef_ce0;
    wire                          int_an32Coef_we0;
    wire [3:0]                    int_an32Coef_be0;
    wire [31:0]                   int_an32Coef_d0;
...
//------------------------Instantiation------------------
// int_an32Coef
fir_n11_maxi_AXILiteS_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 12 )
) int_an32Coef (
    .clk0     ( ACLK ),
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_REGXFERLENG_V_DATA_0: begin
                    rdata <= int_regXferLeng_V[31:0];
                end
            endcase
        end
...
assign regXferLeng_V = int_regXferLeng_V;
// int_ap_start
always @(posedge ACLK) begin
    if (ARESET)
        int_ap_start <= 1'b0;
...
// int_regXferLeng_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_regXferLeng_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_REGXFERLENG_V_DATA_0)
            int_regXferLeng_V[31:0] <= (WDATA[31:0] & wmask) | (int_regXferLeng_V[31:0] & ~wmask);
    end
end
...
assign int_an32Coef_we0      = 1'b0;
assign int_an32Coef_be0      = 1'b0;
assign int_an32Coef_d0       = 1'b0;
...
assign int_an32Coef_we1      = int_an32Coef_write & WVALID;
assign int_an32Coef_be1      = WSTRB;
