...
if {[file isfile fir_n11_maxi.autotvin.dat]} {
	file delete -force fir_n11_maxi.autotvin.dat
}

if {[file isfile fir_n11_maxi.autotvout.dat]} {
	file delete -force fir_n11_maxi.autotvout.dat
}
