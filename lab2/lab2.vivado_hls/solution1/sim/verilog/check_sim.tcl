...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fir_n11_maxi.autotvin_gmem.dat"
         "c.fir_n11_maxi.autotvin_pn32HPInput.dat"
         "c.fir_n11_maxi.autotvin_pn32HPOutput.dat"
         "c.fir_n11_maxi.autotvin_an32Coef.dat"
         "c.fir_n11_maxi.autotvin_regXferLeng_V.dat"
         "c.fir_n11_maxi.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fir_n11_maxi.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
