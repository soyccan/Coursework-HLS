...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fir_n11_maxi.autotvin.dat"
	set constFileTvOut       "fir_n11_maxi.autotvout.dat"
	set constFileHdlTvIn     "fir_n11_maxi.autohdltvin.dat"
	set constFileHdlTvOut    "fir_n11_maxi.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
